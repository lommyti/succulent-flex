...
class App extends Component {
    ...
    if (this.state.start == 'false'){
      return(
        <Typing loop="true" speed={80}>
                <button onClick={()=>this.setSandbox()}> YOU COME ACROSS A BARREN AND SANDY PLAIN. CLICK TO GROW THIS GARDEN  </button>
  ...
  renderFinished(){
    if (this.state.start == 'false'){
      ...
      return(
        <button> WOULD YOU LOOK AT THAT! IT CAME TO LIFE! </button>
      )
    }
  }
    ...
    return (
      <div className="App">
        ...
        <div className="sandbox">
          ...
          <div className="roundleaves">
            {this.state.roundleaves}
          </div>
          <div className="cacti">
            {this.renderCactusBase()}
            <div className="cactus-inside-container">
              {this.state.cactus}
            </div>
          </div>
        </div>
